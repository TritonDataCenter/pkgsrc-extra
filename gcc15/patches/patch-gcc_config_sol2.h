...
--- gcc/config/sol2.h.orig	2026-03-11 17:24:07.000000000 +0000
+++ gcc/config/sol2.h
...
@@ -294,8 +295,9 @@ along with GCC; see the file COPYING3.
...
@@ -306,8 +308,9 @@ along with GCC; see the file COPYING3.
